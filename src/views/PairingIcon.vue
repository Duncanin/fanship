...
import self01 from '@/assets/images/pairing_img/anons/self01.png';
import self02 from '@/assets/images/pairing_img/anons/self02.png';
import self03 from '@/assets/images/pairing_img/anons/self03.png';
import self04 from '@/assets/images/pairing_img/anons/self04.png';
import self05 from '@/assets/images/pairing_img/anons/self05.png';
import self06 from '@/assets/images/pairing_img/anons/self06.png';
import self07 from '@/assets/images/pairing_img/anons/self07.png';
import self08 from '@/assets/images/pairing_img/anons/self08.png';
import self09 from '@/assets/images/pairing_img/anons/self09.png';

const router = useRouter();

const avatars = [
  { src: self01, alt: "self01" },
  { src: self02, alt: "self02" },
  { src: self03, alt: "self03" },
  { src: self04, alt: "self04" },
  { src: self05, alt: "self05" },
  { src: self06, alt: "self06" },
  { src: self07, alt: "self07" },
  { src: self08, alt: "self08" },
  { src: self09, alt: "self09" }
];
